...
from lambda_functions.process_project_files_lambda.ai_service import AIServiceFactory
        ...
        try:
            ...
            for file in file_info.files:
                ...
                if analysis_result:
                    ...
                    logger.error(f"Failed to process file with AI service: {file.file_name}")
    ...
    def _update_database(self, file_info):
        ...
        try:
            ...
            file_update_result = self.db_manager.update_file_info(
                ...
                [file.dict() for file in file_info.files]
            )
